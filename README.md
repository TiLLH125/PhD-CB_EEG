...
Press Enter to send code 2 of 15...
[02/15] Sent   2 (bin 00000010). Actiview (decimal OR 8-bit binary): same red line
Press Enter to send code 3 of 15...
[03/15] Sent   4 (bin 00000100). Actiview (decimal OR 8-bit binary): same red line
Press Enter to send code 4 of 15...
[04/15] Sent   8 (bin 00001000). Actiview (decimal OR 8-bit binary): same red line
Press Enter to send code 5 of 15...
[05/15] Sent  16 (bin 00010000). Actiview (decimal OR 8-bit binary): same red line
Press Enter to send code 6 of 15...
[06/15] Sent  32 (bin 00100000). Actiview (decimal OR 8-bit binary): the red line is gone now
Press Enter to send code 7 of 15...
[07/15] Sent  64 (bin 01000000). Actiview (decimal OR 8-bit binary): now ther is an orange line just below where the reed line was
Press Enter to send code 8 of 15...
[08/15] Sent 128 (bin 10000000). Actiview (decimal OR 8-bit binary): no lines at all, but the red line appeared before this tigger was sent
Press Enter to send code 9 of 15...
[09/15] Sent  11 (bin 00001011). Actiview (decimal OR 8-bit binary): red line is now back
Press Enter to send code 10 of 15...
[10/15] Sent  21 (bin 00010101). Actiview (decimal OR 8-bit binary): now both a dark brown line (above the red line) and the red line are on the trigger interface
Press Enter to send code 11 of 15...
[11/15] Sent  31 (bin 00011111). Actiview (decimal OR 8-bit binary): same again, brown and red line
Press Enter to send code 12 of 15...
[12/15] Sent  41 (bin 00101001). Actiview (decimal OR 8-bit binary): both lines are gone now
Press Enter to send code 13 of 15...
[13/15] Sent  51 (bin 00110011). Actiview (decimal OR 8-bit binary): red line is back again
Press Enter to send code 14 of 15...
[14/15] Sent 127 (bin 01111111). Actiview (decimal OR 8-bit binary): Now there is the brown, red, and orange line in the trigger interface
Press Enter to send code 15 of 15...
[15/15] Sent 255 (bin 11111111). Actiview (decimal OR 8-bit binary): same again all three lines brown, red, orange
