function report = CB_EEG_RunFullPreprocessingPipeline_v2(participantID, dataPath, varargin)
...
%
%   report = CB_EEG_RunFullPreprocessingPipeline_v2( ...
%       'MAV01', ...
%       dataPath, ...
%       'BdfFile', 'MAV01.bdf', ...
...
if numel(participantIDs) > 1
    ...
    for i = 1:numel(participantIDs)
        ...
        thisReport = CB_EEG_RunFullPreprocessingPipeline_v2(participantIDs{i}, dataPath, varargin{:});
